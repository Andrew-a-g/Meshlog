...
3. Flash logger node [MeshCore logger firmware]([https://github.com/Anrijs/MeshCore/tree/logger](https://github.com/Anrijs/MeshLog-Firmware)) (Xiao S3 and T3S3 are currently supported)
